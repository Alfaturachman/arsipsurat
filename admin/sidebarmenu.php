    ...
    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
      <div class="menu_section">
        ...
        <ul class="nav side-menu">
          ...
          <!-- <li><a><i class="fa fa-file-text"></i> PENGUKURAN <span class="fa fa-chevron-down"></span></a>
            <ul class="nav child_menu">
              <li><a href="datapengukuranmasuk.php"><i class="fa  fa-inbox"></i>Surat Masuk</a></li>
              <li><a href="datasuratkeluar.php"><i class="fa fa-send"></i>Surat Keluar</a></li>
            </ul>
          </li> -->
