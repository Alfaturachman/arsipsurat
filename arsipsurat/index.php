          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
              <ul class="nav navbar-nav navbar-right">
                ...
                <li class=""><a href="#feature">Profile</a></li>
                <li class=""><a href="#portfolio">Galeri</a></li>
                <ul class="nav navbar-nav navbar-right">
                <li class="">
...
<p class="sub-title pad-bt15">Website ini berguna untuk pengarsipan Surat Masuk dan Surat Keluar di PUSDATARU JAWA TENGAH</p><p>Surat diarsipkan dalam format PDF lalu disesuaikan nomor urutnya.</p>
