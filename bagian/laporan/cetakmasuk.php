    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            if (!empty($_GET['bulan']) && !empty($_GET['tahun'])) {
                ...
                $stmt = $db->prepare("SELECT * FROM tb_surat WHERE MONTH(tanggal) = ? AND YEAR(tanggal) = ? AND kategori = 'Surat Masuk'");
            ...
            ?>
                <font size="5">
                    <center>
                        <b>Laporan Cetak Surat Masuk<br> <?= $nama_bulan[$bulan]; ?>&nbsp;<?= $tahun; ?><br></b>
                    </center>
                </font>
                <br><br>
...
<body>
    ...
    echo "<b>Laporan Cetak Semua Surat Masuk</b>";
    echo "</div>";
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<p class='center'><b>Tidak ada data surat masuk.</b></p>";
    }
    ?>
    <script>
        window.print();
