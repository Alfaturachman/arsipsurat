...
$operator							= mysqli_real_escape_string($db, $_SESSION['nama']);
...
if (
	!($tgl_keluar == '') and !($kode_suratkeluar == '') and !($nomor_suratkeluar == '') and !($nama_bagian == '') and !($tgl_surat == '') and !($kepada_suratkeluar == '') and !($perihal_suratkeluar == '') and !($operator == '') and !($tanggal_entry == '') and !($id_bagian == '') and
	...
	$sql = "INSERT INTO tb_suratkeluar(tanggalkeluar_suratkeluar, kode_suratkeluar, nomor_suratkeluar, nama_bagian, tanggalsurat_suratkeluar, kepada_suratkeluar, perihal_suratkeluar, file_suratkeluar, operator, tanggal_entry, id_bagian)
				values ('$tgl_keluar', '$kode_suratkeluar', '$nomor_suratkeluar', '$nama_bagian', '$tgl_surat', '$kepada_suratkeluar', '$perihal_suratkeluar', '$nama_baru', '$operator', '$tanggal_entry', '$id_bagian')";
