            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  $id_bagian = isset($_SESSION['id_bagian']) ? $_SESSION['id_bagian'] : ''; // Pastikan id_bagian ada di session

                  // Query SQL dasar
                  $sql1 = "SELECT * FROM tb_surat WHERE kategori = 'Surat Keluar'";

                  // Tambahkan kondisi WHERE berdasarkan input
                  $conditions = [];
                  if ($bulan != '') {
